...
Compaction2005_2050ssp1 = ((bulk_density2050_ssp1 - actBD)/actBD)*100
...
Compaction2005_2050ssp5 = ((bulk_density2050_ssp5-actBD)/actBD)*100
...
writeRaster(soc_stock1,"E:/SERENA/WP5_bundles/France/ISRIC_threats_France/Theats_map/SOC_Loss/soc_stock1_ssp1.tif",  overwrite = T)
...
writeRaster(soc_stock2,"E:/SERENA/WP5_bundles/France/ISRIC_threats_France/Theats_map/SOC_Loss/soc_stock2_ssp5.tif",
            overwrite = T)
...
SOC_stock_loss_1 <- (soc_stock1 - SOC_stock_actual)/SOC_stock_actual

plot(SOC_stock_loss_1)

writeRaster(SOC_stock_loss_1,"E:/SERENA/WP5_bundles/France/ISRIC_threats_France/Theats_map/SOC_Loss/SOC_stock_loss_SSP1.tif",
            overwrite = T)

####6.2 difference between SOC stock ssp5 and SOC stock actual----------------
SOC_stock_loss_2 <- (soc_stock2-SOC_stock_actual)/SOC_stock_actual

plot(SOC_stock_loss_2)

writeRaster(SOC_stock_loss_2,"E:/SERENA/WP5_bundles/France/ISRIC_threats_France/Theats_map/SOC_Loss/SOC_stock_loss_SSP5.tif",
            overwrite = T)
...
SOC_stock_loss_1 <- ((soc_stock1 - SOC_stock_actual)/SOC_stock_actual)*100
...
####6.2 difference between SOC stock ssp5 and SOC stock actual----------------
SOC_stock_loss_2 <- ((soc_stock2-SOC_stock_actual)/SOC_stock_actual)*100
...
SoilSealing <-(impev_2050_France - impev_present_France)# we keep absoulute change for 
...
>>>>>>> e55f9c5f50316d3e14b337d4b66f030bf44ed8cd
